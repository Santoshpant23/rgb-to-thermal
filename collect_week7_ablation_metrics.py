...
RUNS = [
    ...
    ("convnext_affine_det", "ConvNeXt affine deterministic", "json", "week7_runs/week7_convnext_affine_deterministic_lam0p5_ann_arbor_robust_sigma03_seed42_e50"),
    ("convnext_affine_det", "ConvNeXt affine deterministic", "json", "week7_runs/week7_convnext_affine_deterministic_lam0p5_ann_arbor_robust_sigma03_seed7_e50"),
    ("convnext_affine_det", "ConvNeXt affine deterministic", "json", "week7_runs/week7_convnext_affine_deterministic_lam0p5_ann_arbor_robust_sigma03_seed123_e50"),
    ...
    ("severity_affine_det", "Severity affine deterministic sigma 0.0", "json", "week7_runs/week7_severity_affine_deterministic_lam0p5_ann_arbor_robust_sigma0p0_seed42_e50"),
    ("severity_affine_det", "Severity affine deterministic sigma 0.1", "json", "week7_runs/week7_severity_affine_deterministic_lam0p5_ann_arbor_robust_sigma0p1_seed42_e50"),
    ("severity_affine_det", "Severity affine deterministic sigma 0.2", "json", "week7_runs/week7_severity_affine_deterministic_lam0p5_ann_arbor_robust_sigma0p2_seed42_e50"),
    ("severity_affine_det", "Severity affine deterministic sigma 0.5", "json", "week7_runs/week7_severity_affine_deterministic_lam0p5_ann_arbor_robust_sigma0p5_seed42_e50"),
]
